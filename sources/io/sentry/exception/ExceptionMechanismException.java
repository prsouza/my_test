...
public final class ExceptionMechanismException extends RuntimeException {
    ...
    public ExceptionMechanismException(Mechanism mechanism, Throwable th2, Thread thread2) {
        this(mechanism, th2, thread2, false);
    }

    public ExceptionMechanismException(Mechanism mechanism, Throwable th2, Thread thread2, boolean z) {
