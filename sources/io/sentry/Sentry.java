...
public final class Sentry {
    ...
    public static SentryId captureException(Throwable th2) {
        return getCurrentHub().captureException(th2);
    }

    public static SentryId captureException(Throwable th2, Object obj) {
        return getCurrentHub().captureException(th2, obj);
    }
    ...
    public static void init() {
        init((OptionsConfiguration<SentryOptions>) b.f168a, false);
    }
    ...
    public static void init(String str) {
        init((OptionsConfiguration<SentryOptions>) new c(str));
    }
    ...
    public static ITransaction startTransaction(TransactionContext transactionContext, CustomSamplingContext customSamplingContext, boolean z, Date date, boolean z10, TransactionFinishedCallback transactionFinishedCallback) {
        return getCurrentHub().startTransaction(transactionContext, customSamplingContext, z, date, z10, transactionFinishedCallback);
    }
