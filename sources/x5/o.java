...
public final class o {
    ...
    public static final int[] f12860a = {R.attr.colorPrimary};

    /* renamed from: b  reason: collision with root package name */
    public static final int[] f12861b = {R.attr.colorPrimaryVariant};

    public static void a(Context context, AttributeSet attributeSet, int i, int i10) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.I, i, i10);
        boolean z = obtainStyledAttributes.getBoolean(1, false);
        obtainStyledAttributes.recycle();
        if (z) {
            TypedValue typedValue = new TypedValue();
            if (!context.getTheme().resolveAttribute(R.attr.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context, f12861b, "Theme.MaterialComponents");
            }
        }
        c(context, f12860a, "Theme.AppCompat");
    }
    ...
    public static void b(android.content.Context r4, android.util.AttributeSet r5, int[] r6, int r7, int r8, int... r9) {
        ...
        L_0x003e:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: x5.o.b(android.content.Context, android.util.AttributeSet, int[], int, int, int[]):void");
    }
    ...
    public static void c(Context context, int[] iArr, String str) {
        ...
        if (!z) {
            throw new IllegalArgumentException(androidx.fragment.app.o.c("The style on this component requires your app theme to be ", str, " (or a descendant)."));
        }
    }
