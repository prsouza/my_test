...
public final class a {
    ...
    public static /* synthetic */ class C0259a {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: y6.a.C0259a.<clinit>():void");
        }
    }
    ...
    public static int a(int r5, int r6, java.math.RoundingMode r7) {
        ...
        L_0x0063:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: y6.a.a(int, int, java.math.RoundingMode):int");
    }

    public static int b(int i, RoundingMode roundingMode) {
        if (i > 0) {
            boolean z = true;
            switch (C0259a.f13493a[roundingMode.ordinal()]) {
                case 1:
                    boolean z10 = i > 0;
                    if (((i - 1) & i) != 0) {
                        z = false;
