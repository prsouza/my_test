...
public final class k extends a {
    ...
    public k(String str, f fVar, int i, List list, boolean z) {
        super(str, true);
        this.f9988e = fVar;
        this.f9989f = i;
        this.g = list;
    ...
    public final long a() {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: pf.k.a():long");
    }
}
