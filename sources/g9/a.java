...
public final class a {
    ...
    public static final Type[] f5260a = new Type[0];

    /* renamed from: g9.a$a  reason: collision with other inner class name */
    public static final class C0085a implements GenericArrayType, Serializable {

        /* renamed from: a  reason: collision with root package name */
        public final Type f5261a;

        public C0085a(Type type) {
            this.f5261a = a.a(type);
        }
    ...
    public static final class b implements ParameterizedType, Serializable {
        ...
        public final Type f5263b;

        /* renamed from: c  reason: collision with root package name */
        public final Type[] f5264c;
        ...
        public b(Type type, Type type2, Type... typeArr) {
            ...
            this.f5262a = type == null ? null : a.a(type);
            this.f5263b = a.a(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f5264c = typeArr2;
            int length = typeArr2.length;
            for (int i = 0; i < length; i++) {
                Objects.requireNonNull(this.f5264c[i]);
                a.g(this.f5264c[i]);
                Type[] typeArr3 = this.f5264c;
        ...
        public final int hashCode() {
            int hashCode = Arrays.hashCode(this.f5264c) ^ this.f5263b.hashCode();
            Type type = this.f5262a;
        ...
        public final String toString() {
            ...
            if (length == 0) {
                return a.i(this.f5263b);
            }
            StringBuilder sb2 = new StringBuilder((length + 1) * 30);
            sb2.append(a.i(this.f5263b));
            sb2.append("<");
            sb2.append(a.i(this.f5264c[0]));
            for (int i = 1; i < length; i++) {
                sb2.append(", ");
                sb2.append(a.i(this.f5264c[i]));
            }
            sb2.append(">");
            return sb2.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final Type f5265a;

        /* renamed from: b  reason: collision with root package name */
        public final Type f5266b;

        public c(Type[] typeArr, Type[] typeArr2) {
            Class<Object> cls = Object.class;
            boolean z = true;
            ad.c.m(typeArr2.length <= 1);
            ad.c.m(typeArr.length == 1);
            if (typeArr2.length == 1) {
                Objects.requireNonNull(typeArr2[0]);
                a.g(typeArr2[0]);
                ad.c.m(typeArr[0] != cls ? false : z);
                this.f5266b = a.a(typeArr2[0]);
                this.f5265a = cls;
                return;
            }
        ...
        public final Type[] getUpperBounds() {
            return new Type[]{this.f5265a};
        }

        public final int hashCode() {
            Type type = this.f5266b;
            return (type != null ? type.hashCode() + 31 : 1) ^ (this.f5265a.hashCode() + 31);
        }
        ...
        public final String toString() {
            ...
            if (this.f5266b != null) {
                q10 = a.b.q("? super ");
                type = this.f5266b;
            } else if (this.f5265a == Object.class) {
                return "?";
            } else {
                q10 = a.b.q("? extends ");
                type = this.f5265a;
    ...
    public static Type a(Type type) {
        if (type instanceof Class) {
            ...
            return cls.isArray() ? new C0085a(a(cls.getComponentType())) : cls;
        } else if (type instanceof ParameterizedType) {
            ParameterizedType parameterizedType = (ParameterizedType) type;
            return new b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        } else if (type instanceof GenericArrayType) {
            return new C0085a(((GenericArrayType) type).getGenericComponentType());
        } else {
    ...
    public static java.lang.reflect.Type d(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10, java.util.Collection<java.lang.reflect.TypeVariable> r11) {
        /*
        L_0x0000:
        ...
        L_0x001e:
            ...
            goto L_0x004a
        L_0x0021:
            java.lang.reflect.Type r2 = b(r8, r9, r10)
        ...
        L_0x004e:
            ...
            java.lang.reflect.Type r8 = d(r8, r9, r10, r11)
        ...
        L_0x006c:
            ...
            java.lang.reflect.Type r8 = d(r8, r9, r0, r11)
            if (r0 != r8) goto L_0x007d
            goto L_0x0082
        L_0x007d:
            g9.a$a r10 = new g9.a$a
            r10.<init>(r8)
        L_0x0082:
            return r10
        L_0x0083:
            ...
            java.lang.reflect.Type r3 = d(r8, r9, r0, r11)
        ...
        L_0x009c:
            ...
            r6 = r4[r1]
            java.lang.reflect.Type r6 = d(r8, r9, r6, r11)
            r7 = r4[r1]
        ...
        L_0x00c3:
            ...
            r3 = r0[r1]
            java.lang.reflect.Type r8 = d(r8, r9, r3, r11)
            r9 = r0[r1]
        ...
        L_0x00fa:
            ...
            r0 = r3[r1]
            java.lang.reflect.Type r8 = d(r8, r9, r0, r11)     // Catch:{ all -> 0x011f }
            r9 = r3[r1]
            if (r8 == r9) goto L_0x0121
            boolean r9 = r8 instanceof java.lang.reflect.WildcardType
        ...
        L_0x0117:
            g9.a$c r9 = new g9.a$c
            java.lang.reflect.Type[] r10 = f5260a
            r9.<init>(r8, r10)
            return r9
        L_0x011f:
            r8 = move-exception
        ...
        L_0x0121:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: g9.a.d(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type, java.util.Collection):java.lang.reflect.Type");
    }
    ...
    public static Type f(Type type, Class<?> cls, Class<?> cls2) {
        ...
        ad.c.m(cls2.isAssignableFrom(cls));
        return c(type, cls, b(type, cls, cls2));
    }

    public static void g(Type type) {
        ad.c.m(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
    ...
    public static Class<?> h(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            ad.c.m(rawType instanceof Class);
