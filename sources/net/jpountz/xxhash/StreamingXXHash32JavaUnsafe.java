...
final class StreamingXXHash32JavaUnsafe extends AbstractStreamingXXHash32Java {
    ...
    public int getValue() {
        ...
        while (i11 <= this.memSize - 4) {
            i10 = Integer.rotateLeft((UnsafeUtils.readIntLE(this.memory, i11) * XXHashConstants.PRIME3) + i10, 17) * XXHashConstants.PRIME4;
            i11 += 4;
        }
        while (i11 < this.memSize) {
            i10 = Integer.rotateLeft(((UnsafeUtils.readByte(this.memory, i11) & 255) * XXHashConstants.PRIME5) + i10, 11) * XXHashConstants.PRIME1;
            i11++;
        }
    ...
    public void update(byte[] bArr, int i, int i10) {
        ...
        if (i11 > 0) {
            ...
            int readIntLE = (UnsafeUtils.readIntLE(this.memory, 0) * XXHashConstants.PRIME2) + this.f8996v1;
            this.f8996v1 = readIntLE;
            this.f8996v1 = Integer.rotateLeft(readIntLE, 13) * XXHashConstants.PRIME1;
            int readIntLE2 = (UnsafeUtils.readIntLE(this.memory, 4) * XXHashConstants.PRIME2) + this.f8997v2;
            this.f8997v2 = readIntLE2;
            this.f8997v2 = Integer.rotateLeft(readIntLE2, 13) * XXHashConstants.PRIME1;
            int readIntLE3 = (UnsafeUtils.readIntLE(this.memory, 8) * XXHashConstants.PRIME2) + this.f8998v3;
            this.f8998v3 = readIntLE3;
            this.f8998v3 = Integer.rotateLeft(readIntLE3, 13) * XXHashConstants.PRIME1;
            int readIntLE4 = (UnsafeUtils.readIntLE(this.memory, 12) * XXHashConstants.PRIME2) + this.f8999v4;
        ...
        while (i <= i13) {
            i14 = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i) * XXHashConstants.PRIME2) + i14, 13) * XXHashConstants.PRIME1;
            int i18 = i + 4;
            ...
            int i20 = i19 + 4;
            i17 = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i20) * XXHashConstants.PRIME2) + i17, 13) * XXHashConstants.PRIME1;
            i = i20 + 4;
        }
        this.f8996v1 = i14;
        this.f8997v2 = i15;
