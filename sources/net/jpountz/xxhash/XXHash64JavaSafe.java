...
final class XXHash64JavaSafe extends XXHash64 {
    ...
    public long hash(byte[] bArr, int i, int i10, long j10) {
        ...
        if (i12 >= 32) {
            ...
            int i15 = i;
            while (true) {
                j17 = Long.rotateLeft((SafeUtils.readLongLE(bArr2, i15) * j18) + j17, 31) * XXHashConstants.PRIME64_1;
                int i16 = i15 + 8;
                j16 = Long.rotateLeft((SafeUtils.readLongLE(bArr2, i16) * j18) + j16, 31) * XXHashConstants.PRIME64_1;
                int i17 = i16 + 8;
                j14 = Long.rotateLeft((SafeUtils.readLongLE(bArr2, i17) * j18) + j14, 31) * XXHashConstants.PRIME64_1;
                int i18 = i17 + 8;
                rotateLeft = Long.rotateLeft((SafeUtils.readLongLE(bArr2, i18) * XXHashConstants.PRIME64_2) + j15, 31) * XXHashConstants.PRIME64_1;
                i15 = i18 + 8;
                if (i15 > i14) {
                    break;
                }
        ...
        int i20 = i11;
        while (i20 <= i13 - 8) {
            j21 = (Long.rotateLeft(j21 ^ (Long.rotateLeft(SafeUtils.readLongLE(bArr2, i20) * XXHashConstants.PRIME64_2, 31) * XXHashConstants.PRIME64_1), 27) * XXHashConstants.PRIME64_1) + XXHashConstants.PRIME64_4;
            i20 += 8;
        }
        if (i20 <= i13 - 4) {
            j21 = (Long.rotateLeft(j21 ^ ((((long) SafeUtils.readIntLE(bArr2, i20)) & 4294967295L) * XXHashConstants.PRIME64_1), 23) * XXHashConstants.PRIME64_2) + XXHashConstants.PRIME64_3;
            i20 += 4;
        }
        while (i20 < i13) {
            j21 = Long.rotateLeft(j21 ^ (((long) (SafeUtils.readByte(bArr2, i20) & 255)) * XXHashConstants.PRIME64_5), 11) * XXHashConstants.PRIME64_1;
            i20++;
        }
