...
final class StreamingXXHash64JavaUnsafe extends AbstractStreamingXXHash64Java {
    ...
    public static class Factory implements StreamingXXHash64.Factory {
        ...
        public StreamingXXHash64 newStreamingHash(long j10) {
            return new StreamingXXHash64JavaUnsafe(j10);
        }
    }

    public StreamingXXHash64JavaUnsafe(long j10) {
        super(j10);
    }
    ...
    public long getValue() {
        ...
        while (true) {
            ...
            j15 = (Long.rotateLeft(j15 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(this.memory, i10) * XXHashConstants.PRIME64_2, 31) * XXHashConstants.PRIME64_1), 27) * XXHashConstants.PRIME64_1) + XXHashConstants.PRIME64_4;
            i10 += 8;
        }
        if (i10 <= i - 4) {
            j15 = (Long.rotateLeft(j15 ^ ((((long) UnsafeUtils.readIntLE(this.memory, i10)) & 4294967295L) * XXHashConstants.PRIME64_1), 23) * XXHashConstants.PRIME64_2) + XXHashConstants.PRIME64_3;
            i10 += 4;
        }
    ...
    public void update(byte[] bArr, int i, int i10) {
        ...
        if (i13 > 0) {
            ...
            long readLongLE = this.f9000v1 + (UnsafeUtils.readLongLE(this.memory, 0) * XXHashConstants.PRIME64_2);
            this.f9000v1 = readLongLE;
            this.f9000v1 = Long.rotateLeft(readLongLE, 31) * XXHashConstants.PRIME64_1;
            long readLongLE2 = this.f9001v2 + (UnsafeUtils.readLongLE(this.memory, 8) * XXHashConstants.PRIME64_2);
            this.f9001v2 = readLongLE2;
            this.f9001v2 = Long.rotateLeft(readLongLE2, 31) * XXHashConstants.PRIME64_1;
            long readLongLE3 = this.f9002v3 + (UnsafeUtils.readLongLE(this.memory, 16) * XXHashConstants.PRIME64_2);
            this.f9002v3 = readLongLE3;
            this.f9002v3 = Long.rotateLeft(readLongLE3, 31) * XXHashConstants.PRIME64_1;
            long readLongLE4 = this.f9003v4 + (UnsafeUtils.readLongLE(this.memory, 24) * XXHashConstants.PRIME64_2);
        ...
        while (i11 <= i15) {
            j10 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr2, i11) * XXHashConstants.PRIME64_2) + j10, 31) * XXHashConstants.PRIME64_1;
            int i16 = i11 + 8;
            j11 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr2, i16) * XXHashConstants.PRIME64_2) + j11, 31) * XXHashConstants.PRIME64_1;
            int i17 = i16 + 8;
            j12 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr2, i17) * XXHashConstants.PRIME64_2) + j12, 31) * XXHashConstants.PRIME64_1;
            int i18 = i17 + 8;
            j13 = Long.rotateLeft((UnsafeUtils.readLongLE(bArr2, i18) * XXHashConstants.PRIME64_2) + j13, 31) * XXHashConstants.PRIME64_1;
            i11 = i18 + 8;
        }
        this.f9000v1 = j10;
        this.f9001v2 = j11;
