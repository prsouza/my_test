...
final class XXHash32JavaUnsafe extends XXHash32 {
    ...
    public int hash(byte[] bArr, int i, int i10, int i11) {
        ...
        if (i10 >= 16) {
            ...
            while (true) {
                rotateLeft = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i) * XXHashConstants.PRIME2) + i15, 13) * XXHashConstants.PRIME1;
                int i19 = i + 4;
                ...
                int i21 = i20 + 4;
                i18 = Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i21) * XXHashConstants.PRIME2) + i18, 13) * XXHashConstants.PRIME1;
                i = i21 + 4;
                if (i > i14) {
                    break;
                }
        ...
        int i22 = i12 + i10;
        while (i <= i13 - 4) {
            i22 = XXHashConstants.PRIME4 * Integer.rotateLeft((UnsafeUtils.readIntLE(bArr, i) * XXHashConstants.PRIME3) + i22, 17);
            i += 4;
        }
        while (i < i13) {
            i22 = Integer.rotateLeft(((UnsafeUtils.readByte(bArr, i) & 255) * XXHashConstants.PRIME5) + i22, 11) * XXHashConstants.PRIME1;
            i++;
        }
