...
final class LZ4JavaSafeSafeDecompressor extends LZ4SafeDecompressor {
    ...
    public int decompress(byte[] r18, int r19, int r20, byte[] r21, int r22, int r23) {
        /*
            ...
            r2 = r21
            r3 = r22
            net.jpountz.util.SafeUtils.checkRange(r18, r19, r20)
            net.jpountz.util.SafeUtils.checkRange(r21, r22, r23)
            r4 = 1
            if (r23 != 0) goto L_0x0023
            if (r1 != r4) goto L_0x001b
            byte r0 = net.jpountz.util.SafeUtils.readByte(r18, r19)
        ...
        L_0x0023:
            ...
            r4 = r19
        L_0x002b:
            byte r8 = net.jpountz.util.SafeUtils.readByte(r0, r4)
        ...
        L_0x003a:
            ...
            int r11 = r4 + 1
            byte r4 = net.jpountz.util.SafeUtils.readByte(r0, r4)
        ...
        L_0x0054:
            ...
            goto L_0x00af
        L_0x0063:
            net.jpountz.lz4.LZ4SafeUtils.wildArraycopy(r0, r4, r2, r7, r6)
            int r4 = net.jpountz.util.SafeUtils.readShortLE(r0, r14)
            int r14 = r14 + 2
            int r4 = r11 - r4
        ...
        L_0x0075:
            ...
            int r7 = r14 + 1
            byte r8 = net.jpountz.util.SafeUtils.readByte(r0, r14)
        ...
        L_0x0089:
            ...
            net.jpountz.lz4.LZ4SafeUtils.safeIncrementalCopy(r2, r4, r11, r6)
            goto L_0x00a2
        L_0x0095:
            net.jpountz.lz4.LZ4Exception r0 = new net.jpountz.lz4.LZ4Exception
            ...
            throw r0
        L_0x009f:
            net.jpountz.lz4.LZ4SafeUtils.wildIncrementalCopy(r2, r4, r11, r7)
        L_0x00a2:
            r6 = 1
            r4 = r14
            goto L_0x002b
        ...
        L_0x00af:
            ...
            net.jpountz.lz4.LZ4SafeUtils.safeArraycopy(r0, r4, r2, r7, r6)
            int r11 = r11 - r3
            return r11
        L_0x00ba:
            net.jpountz.lz4.LZ4Exception r0 = new net.jpountz.lz4.LZ4Exception
