...
public abstract class LZ4Compressor {
    public abstract int compress(ByteBuffer byteBuffer, int i, int i10, ByteBuffer byteBuffer2, int i11, int i12);

    public final int compress(byte[] bArr, int i, int i10, byte[] bArr2, int i11) {
        return compress(bArr, i, i10, bArr2, i11, bArr2.length - i11);
    }

    public abstract int compress(byte[] bArr, int i, int i10, byte[] bArr2, int i11, int i12);
    ...
    public final byte[] compress(byte[] bArr, int i, int i10) {
