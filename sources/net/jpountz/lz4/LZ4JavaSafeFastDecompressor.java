...
final class LZ4JavaSafeFastDecompressor extends LZ4FastDecompressor {
    ...
    public int decompress(byte[] bArr, int i, byte[] bArr2, int i10, int i11) {
        ...
        if (i11 != 0) {
            ...
            int i16 = i10;
            while (true) {
                byte readByte3 = SafeUtils.readByte(bArr, i15) & 255;
                int i17 = i15 + 1;
                int i18 = readByte3 >>> 4;
                if (i18 == 15) {
                    while (true) {
                ...
                int i20 = i14 - 8;
                if (i19 <= i20) {
                    LZ4SafeUtils.wildArraycopy(bArr, i17, bArr2, i16, i18);
                    int i21 = i17 + i18;
                    ...
                    if (i22 >= i10) {
                        ...
                        if (i23 == 15) {
                            while (true) {
                                i12 = i15 + 1;
                                readByte = SafeUtils.readByte(bArr, i15);
                                if (readByte != -1) {
                                    break;
                                }
                                i23 += 255;
                    ...
                    LZ4SafeUtils.safeArraycopy(bArr, i17, bArr2, i16, i18);
                    return (i17 + i18) - i;
                } else {
