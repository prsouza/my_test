...
public abstract class LZ4SafeDecompressor implements LZ4UnknownSizeDecompressor {
    public abstract int decompress(ByteBuffer byteBuffer, int i, int i10, ByteBuffer byteBuffer2, int i11, int i12);

    public final int decompress(byte[] bArr, int i, int i10, byte[] bArr2, int i11) {
        return decompress(bArr, i, i10, bArr2, i11, bArr2.length - i11);
    }

    public abstract int decompress(byte[] bArr, int i, int i10, byte[] bArr2, int i11, int i12);
    ...
    public final byte[] decompress(byte[] bArr, int i, int i10, int i11) {
        byte[] bArr2 = new byte[i11];
        int decompress = decompress(bArr, i, i10, bArr2, 0, i11);
        return decompress != i11 ? Arrays.copyOf(bArr2, decompress) : bArr2;
    }
