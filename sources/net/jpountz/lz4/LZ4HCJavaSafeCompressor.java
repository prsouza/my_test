...
final class LZ4HCJavaSafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x01c9, code lost:
        ...
        r23 = r9;
        r9 = r10;
        r6 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r2, r23.end(), r0.start, r0.ref, r0.len, r7, net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r2, r16, r9.start, r9.ref, r9.len, r7, r17, r9), r9);
        r3 = r0.end();
        r9 = r23;
        r8 = r0;
        r2 = r3;
    ...
    public int compress(byte[] r22, int r23, int r24, byte[] r25, int r26, int r27) {
        /*
            ...
            net.jpountz.util.SafeUtils.checkRange(r25, r26, r27)
            int r1 = r0 + r24
            int r10 = r26 + r27
            int r11 = r1 + -12
            int r12 = r1 + -5
        ...
        L_0x0115:
            ...
            r23 = r9
            r9 = r10
            int r17 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r2, r3, r4, r5, r6, r7, r8, r9)
            int r16 = r23.end()
            r9 = r23
        ...
        L_0x01c9:
            ...
            int r5 = r0.ref
            int r6 = r0.len
            int r6 = net.jpountz.lz4.LZ4SafeUtils.encodeSequence(r2, r3, r4, r5, r6, r7, r8, r9)
            int r3 = r0.end()
            r9 = r23
            r8 = r0
            r2 = r3
    ...
    public class HashTable {
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i10, LZ4Utils.Match match) {
            ...
            if (hashPointer < i - 4 || hashPointer > i || hashPointer < this.base) {
                ...
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i)) {
                    i12 = i - hashPointer;
                    i11 = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i10) + 4;
                    match.len = i11;
            ...
            for (int i13 = 0; i13 < LZ4HCJavaSafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i - LZ4Constants.MAX_DISTANCE) + 1) && hashPointer <= i; i13++) {
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i) && (commonBytes = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i10) + 4) > match.len) {
                    match.ref = hashPointer;
        ...
        public boolean insertAndFindWiderMatch(byte[] bArr, int i, int i10, int i11, int i12, LZ4Utils.Match match) {
            ...
            int hashPointer = hashPointer(bArr, i);
            for (int i13 = 0; i13 < LZ4HCJavaSafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i - LZ4Constants.MAX_DISTANCE) + 1) && hashPointer <= i; i13++) {
                if (LZ4SafeUtils.readIntEquals(bArr, hashPointer, i) && (commonBytes = LZ4SafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i11) + 4 + commonBytesBackward) > match.len) {
                    match.len = commonBytes;
                    match.ref = hashPointer - (commonBytesBackward = LZ4SafeUtils.commonBytesBackward(bArr, hashPointer, i, this.base, i10));
