...
final class LZ4JavaSafeCompressor extends LZ4Compressor {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x00ae, code lost:
        ...
        r15 = net.jpountz.util.SafeUtils.readShort(r2, r9) + r1;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00d3, code lost:
        if (net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r8, r15) != false) goto L_0x00de;
     */
    ...
    public static int compress64k(byte[] r17, int r18, int r19, byte[] r20, int r21, int r22) {
        ...
        L_0x0075:
            ...
            byte r13 = net.jpountz.util.SafeUtils.readByte(r3, r10)
            r13 = r13 | r11
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r13)
            int r9 = r9 + -15
        ...
        L_0x00ae:
            int r9 = r8 + -2
            int r12 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r9)
            int r12 = net.jpountz.lz4.LZ4Utils.hash64k(r12)
            int r9 = r9 - r1
            net.jpountz.util.SafeUtils.writeShort(r2, r12, r9)
            int r9 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r8)
            int r9 = net.jpountz.lz4.LZ4Utils.hash64k(r9)
            int r12 = net.jpountz.util.SafeUtils.readShort(r2, r9)
            int r15 = r12 + r1
            int r12 = r8 - r1
            net.jpountz.util.SafeUtils.writeShort(r2, r9, r12)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0063, code lost:
        r12 = net.jpountz.lz4.LZ4SafeUtils.commonBytesBackward(r0, r15, r7, r1, r9);
        r7 = r7 - r12;
        r15 = r15 - r12;
        r12 = r7 - r9;
        r13 = r10 + 1;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x007d, code lost:
        net.jpountz.util.SafeUtils.writeByte(r3, r10, 240);
        r13 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r12 - 15, r3, r13);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0089, code lost:
        net.jpountz.util.SafeUtils.writeByte(r3, r10, r12 << 4);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x008e, code lost:
        net.jpountz.lz4.LZ4SafeUtils.wildArraycopy(r0, r9, r3, r13, r12);
        r13 = r13 + r12;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0092, code lost:
        net.jpountz.util.SafeUtils.writeShortLE(r3, r13, r11);
        r13 = r13 + 2;
        r7 = r7 + 4;
        r9 = net.jpountz.lz4.LZ4SafeUtils.commonBytes(r0, r15 + 4, r7, r4);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x00ab, code lost:
        net.jpountz.util.SafeUtils.writeByte(r3, r10, net.jpountz.util.SafeUtils.readByte(r3, r10) | 15);
        r10 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r9 - 15, r3, r13);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x00d5, code lost:
        r9 = r7 - 2;
        net.jpountz.util.SafeUtils.writeInt(r8, net.jpountz.lz4.LZ4Utils.hash(net.jpountz.util.SafeUtils.readInt(r0, r9)), r9);
        r9 = net.jpountz.lz4.LZ4Utils.hash(net.jpountz.util.SafeUtils.readInt(r0, r7));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x00fb, code lost:
        if (net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r15, r7) != false) goto L_0x00fe;
     */
    ...
    public int compress(byte[] r19, int r20, int r21, byte[] r22, int r23, int r24) {
        ...
        L_0x0046:
            ...
            int r15 = net.jpountz.util.SafeUtils.readInt((int[]) r8, (int) r14)
            r21 = r11
            int r11 = r7 - r15
            net.jpountz.util.SafeUtils.writeInt(r8, r14, r7)
            r14 = 65536(0x10000, float:9.18355E-41)
            if (r11 >= r14) goto L_0x011a
            boolean r16 = net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r15, r7)
            if (r16 == 0) goto L_0x011a
            int r12 = net.jpountz.lz4.LZ4SafeUtils.commonBytesBackward(r0, r15, r7, r1, r9)
            int r7 = r7 - r12
            int r15 = r15 - r12
            int r12 = r7 - r9
            int r13 = r10 + 1
            ...
            int r14 = r12 + -15
            int r13 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r14, r3, r13)
            goto L_0x008e
        L_0x0089:
            int r14 = r12 << 4
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r14)
        ...
        L_0x0092:
            ...
            int r7 = r7 + 4
            int r15 = r15 + 4
            int r9 = net.jpountz.lz4.LZ4SafeUtils.commonBytes(r0, r15, r7, r4)
            int r11 = r13 + 6
            int r12 = r9 >>> 8
            int r11 = r11 + r12
            ...
            byte r12 = net.jpountz.util.SafeUtils.readByte(r3, r10)
            r12 = r12 | r11
            net.jpountz.util.SafeUtils.writeByte(r3, r10, r12)
            int r9 = r9 + -15
            int r9 = net.jpountz.lz4.LZ4SafeUtils.writeLen(r9, r3, r13)
            r10 = r9
            goto L_0x00c4
        L_0x00bb:
            byte r12 = net.jpountz.util.SafeUtils.readByte(r3, r10)
        ...
        L_0x00d5:
            ...
            net.jpountz.util.SafeUtils.writeInt(r8, r12, r9)
            int r9 = net.jpountz.util.SafeUtils.readInt((byte[]) r0, (int) r7)
            int r9 = net.jpountz.lz4.LZ4Utils.hash(r9)
            int r15 = net.jpountz.util.SafeUtils.readInt((int[]) r8, (int) r9)
            net.jpountz.util.SafeUtils.writeInt(r8, r9, r7)
            int r9 = r7 - r15
            r12 = 65536(0x10000, float:9.18355E-41)
            if (r9 >= r12) goto L_0x0106
            boolean r13 = net.jpountz.lz4.LZ4SafeUtils.readIntEquals(r0, r15, r7)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x010d, code lost:
        ...
        r13 = net.jpountz.util.SafeUtils.readInt(r7, r9);
    ...
    public int compress(java.nio.ByteBuffer r19, int r20, int r21, java.nio.ByteBuffer r22, int r23, int r24) {
        ...
        L_0x010d:
            ...
            net.jpountz.util.SafeUtils.writeInt(r7, r13, r9)
            int r9 = net.jpountz.util.ByteBufferUtils.readInt(r5, r1)
            int r9 = net.jpountz.lz4.LZ4Utils.hash(r9)
            int r13 = net.jpountz.util.SafeUtils.readInt((int[]) r7, (int) r9)
            net.jpountz.util.SafeUtils.writeInt(r7, r9, r1)
            int r9 = r1 - r13
            r14 = 65536(0x10000, float:9.18355E-41)
