...
public final class s extends x<s, b> implements r0 {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: h7.s.a.<clinit>():void");
        }
    }

    public static final class b extends x.a<s, b> implements r0 {
        public b() {
    ...
    public static s x(i iVar, p pVar) throws a0 {
        return (s) x.s(DEFAULT_INSTANCE, iVar, pVar);
    }

    public final Object o(x.f fVar) {
        switch (a.f5891a[fVar.ordinal()]) {
            case 1:
                return new s();
            case 2:
                return new b();
