...
public final class f0 extends x<f0, b> implements r0 {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: h7.f0.a.<clinit>():void");
        }
    }

    public static final class b extends x.a<f0, b> implements r0 {
        public b() {
    ...
    public static f0 z(i iVar, p pVar) throws a0 {
        return (f0) x.s(DEFAULT_INSTANCE, iVar, pVar);
    }

    public final Object o(x.f fVar) {
        switch (a.f5872a[fVar.ordinal()]) {
            case 1:
                return new f0();
            case 2:
                return new b();
