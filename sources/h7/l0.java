...
public final class l0 extends x<l0, b> implements r0 {
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: h7.l0.a.<clinit>():void");
        }
    }

    public static final class b extends x.a<l0, b> implements r0 {
        public b() {
    ...
    public static l0 x(i iVar, p pVar) throws a0 {
        return (l0) x.s(DEFAULT_INSTANCE, iVar, pVar);
    }

    public final Object o(x.f fVar) {
        switch (a.f5884a[fVar.ordinal()]) {
            case 1:
                return new l0();
            case 2:
                return new b();
            case 3:
                return new d1(DEFAULT_INSTANCE, "\u0000\u0000", (Object[]) null);
            case 4:
