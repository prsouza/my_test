...
public final class y1 extends b {
    ...
    public final /* synthetic */ long[] f644w;

    /* renamed from: x  reason: collision with root package name */
    public final /* synthetic */ z1 f645x;

    public y1(z1 z1Var, int i, long[] jArr) {
        this.f645x = z1Var;
        this.f643v = i;
        this.f644w = jArr;
    }
    ...
    public final f i1(int i) {
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < this.f643v; i11++) {
            long j10 = (long) (((i11 ^ i) - 1) >> 31);
            for (int i12 = 0; i12 < 4; i12++) {
                long j11 = jArr[i12];
                long[] jArr3 = this.f644w;
    ...
    public final f j1(int i) {
        ...
        for (int i11 = 0; i11 < 4; i11++) {
            long j10 = jArr[i11];
            long[] jArr3 = this.f644w;
            jArr[i11] = j10 ^ jArr3[i10 + i11];
            jArr2[i11] = jArr2[i11] ^ jArr3[(i10 + 4) + i11];
        }
        return r2(jArr, jArr2);
    }
    ...
    public final f r2(long[] jArr, long[] jArr2) {
        ...
        return new a2(z1Var, u1Var, u1Var2, eVarArr);
    }
