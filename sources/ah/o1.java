...
public final class o1 extends b {
    ...
    public final /* synthetic */ long[] f572w;

    /* renamed from: x  reason: collision with root package name */
    public final /* synthetic */ p1 f573x;

    public o1(p1 p1Var, int i, long[] jArr) {
        this.f573x = p1Var;
        this.f571v = i;
        this.f572w = jArr;
    }
    ...
    public final f i1(int i) {
        ...
        int i10 = 0;
        for (int i11 = 0; i11 < this.f571v; i11++) {
            long j10 = (long) (((i11 ^ i) - 1) >> 31);
            for (int i12 = 0; i12 < 3; i12++) {
                long j11 = jArr[i12];
                long[] jArr3 = this.f572w;
    ...
    public final f r2(long[] jArr, long[] jArr2) {
        ...
        return new q1(p1Var, k1Var, k1Var2, eVarArr);
    }
