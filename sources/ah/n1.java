...
public final class n1 extends f.b {
    public n1(d dVar, e eVar, e eVar2) {
        super(dVar, eVar, eVar2);
    }

    public n1(d dVar, e eVar, e eVar2, e[] eVarArr) {
    ...
    public final f a(f fVar) {
        ...
        if (eVar8.h()) {
            ...
            eVar5 = c10.m().a(c10).a(eVar12).b();
            if (eVar5.h()) {
                return new n1(dVar, eVar5, dVar.f13239c);
            }
            ...
            e i11 = i.i(i10);
            if (i11.h()) {
                return new n1(dVar, i11, dVar.f13239c);
            }
            e i12 = a10.i(m10);
            if (!g8) {
                i12 = i12.i(h10);
        ...
        return new n1(dVar, eVar5, eVar4, new e[]{eVar6});
    }
    ...
    public final f m() {
        ...
        e eVar2 = this.f13247c;
        e eVar3 = this.f13248d[0];
        return new n1(this.f13245a, eVar, eVar2.a(eVar3), new e[]{eVar3});
    }
    ...
    public final f w() {
        ...
        e f10 = a.f(eVar2, i, eVar3);
        if (f10.h()) {
            return new n1(dVar, f10, dVar.f13239c);
        }
        e m10 = f10.m();
        e i10 = g ? f10 : f10.i(eVar3);
        e m11 = eVar2.a(eVar).m();
        return new n1(dVar, m10, m11.a(f10).a(eVar3).i(m11).a(m10), new e[]{i10});
    }
    ...
    public final f x(f fVar) {
        ...
        e m11 = eVar3.m();
        e m12 = eVar4.m();
        e a10 = m12.a(m11).a(eVar3.i(eVar4));
        e j10 = eVar5.i(m12).a(m11).j(a10, m10, m12);
        e i = eVar2.i(m12);
        e m13 = i.a(a10).m();
        if (m13.h()) {
        ...
        if (j10.h()) {
            return new n1(dVar, j10, dVar.f13239c);
        }
        e i10 = j10.m().i(i);
        e i11 = j10.i(m13).i(m12);
        return new n1(dVar, i10, j10.a(m13).m().j(a10, eVar5.b(), i11), new e[]{i11});
    }
}
