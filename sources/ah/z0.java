...
public final class z0 extends f.b {
    ...
    public z0(d dVar, e eVar, e eVar2, e[] eVarArr) {
    ...
    public final f a(f fVar) {
        ...
        if (eVar8.h()) {
            ...
            if (eVar5.h()) {
                return new z0(dVar, eVar5, dVar.f13239c.l());
            }
            ...
            e i11 = i.i(i10);
            if (i11.h()) {
                return new z0(dVar, i11, dVar.f13239c.l());
            }
            e i12 = a10.i(m10);
            if (!g8) {
                i12 = i12.i(h10);
        ...
        return new z0(dVar, eVar5, eVar4, new e[]{eVar6});
    }
    ...
    public final f m() {
        ...
        e eVar2 = this.f13247c;
        e eVar3 = this.f13248d[0];
        return new z0(this.f13245a, eVar, eVar2.a(eVar3), new e[]{eVar3});
    }
    ...
    public final f w() {
        ...
        if (f10.h()) {
            return new z0(dVar, f10, dVar.f13239c.l());
        }
        e m11 = f10.m();
        ...
        return new z0(dVar, m11, eVar.n(f10, i).a(m11).a(i10), new e[]{i10});
    }
    ...
    public final f x(f fVar) {
        ...
        if (j10.h()) {
            return new z0(dVar, j10, dVar.f13239c.l());
        }
        e i10 = j10.m().i(i);
        e i11 = j10.i(m13).i(m12);
        return new z0(dVar, i10, j10.a(m13).m().j(a10, b10, i11), new e[]{i11});
    }
}
