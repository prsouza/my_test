...
public class c implements lg.c {
    ...
    public c(int i) {
        this.f8690a = new long[25];
        this.f8691b = new byte[192];
        l(i);
    }
    ...
    public c(c cVar) {
        ...
        this.f8690a = jArr;
        this.f8691b = new byte[192];
        long[] jArr2 = cVar.f8690a;
        System.arraycopy(jArr2, 0, jArr, 0, jArr2.length);
        byte[] bArr = cVar.f8691b;
        System.arraycopy(bArr, 0, this.f8691b, 0, bArr.length);
        this.f8692c = cVar.f8692c;
        this.f8693d = cVar.f8693d;
        this.f8694e = cVar.f8694e;
        this.f8695f = cVar.f8695f;
    }

    public final void a(byte[] bArr, int i) {
        int i10 = this.f8692c >> 6;
        for (int i11 = 0; i11 < i10; i11++) {
            long[] jArr = this.f8690a;
            jArr[i11] = jArr[i11] ^ b.g1(bArr, i);
            i += 8;
        }
        i();
    }
    ...
    public int b(byte[] bArr, int i) {
        m(bArr, i, (long) this.f8694e);
        reset();
        return this.f8694e / 8;
    }

    public String c() {
        StringBuilder d10 = a.d("Keccak-");
    ...
    public final void e() {
        ...
        for (int i11 = 0; i11 < i; i11++) {
            long j10 = jArr[0 + i11];
            b.J0((int) (4294967295L & j10), bArr, i10);
            b.J0((int) (j10 >>> 32), bArr, i10 + 4);
            i10 += 8;
        }
    }
    ...
    public final void i() {
        ...
        while (i < i10) {
            ...
            long j40 = ((j36 << (z ? 1 : 0)) | (j36 >>> -1)) ^ j39;
            long j41 = ((j37 << z) | (j37 >>> -1)) ^ j35;
            long j42 = ((j38 << z) | (j38 >>> -1)) ^ j36;
            long j43 = ((j39 << z) | (j39 >>> -1)) ^ j37;
            long j44 = ((j35 << z) | (j35 >>> -1)) ^ j38;
            long j45 = j10 ^ j40;
            long j46 = j15 ^ j40;
            long j47 = j20 ^ j40;
            long j48 = j25 ^ j40;
    ...
    public final void j(byte[] bArr, int i, int i10) {
        ...
        if (i12 % 8 != 0) {
            ...
            int i13 = i12 >> 3;
            int i14 = this.f8692c >> 3;
            int i15 = 0;
            while (i15 < i10) {
                if (i13 != 0 || i15 > (i11 = i10 - i14)) {
                    int min = Math.min(i14 - i13, i10 - i15);
                    System.arraycopy(bArr, i + i15, this.f8691b, i13, min);
                    i13 += min;
                    i15 += min;
                    if (i13 == i14) {
                        a(this.f8691b, 0);
    ...
    public final void k(int i, int i10) {
        ...
        if (i11 % 8 != 0) {
            ...
            this.f8691b[i11 >> 3] = (byte) (i & ((1 << i10) - 1));
            this.f8693d = i11 + i10;
        } else {
            throw new IllegalStateException("attempt to absorb while squeezing");
        }
        ...
        if (i == 128 || i == 224 || i == 256 || i == 288 || i == 384 || i == 512) {
            ...
            while (true) {
                ...
                if (i11 < jArr.length) {
                    ...
                    Arrays.fill(this.f8691b, (byte) 0);
                    this.f8693d = 0;
                    this.f8695f = false;
                    this.f8694e = (1600 - i10) / 2;
                    return;
                }
            }
        } else {
    ...
    public final void m(byte[] bArr, int i, long j10) {
        if (!this.f8695f) {
            byte[] bArr2 = this.f8691b;
            int i10 = this.f8693d;
            int i11 = i10 >> 3;
            bArr2[i11] = (byte) (bArr2[i11] | ((byte) ((int) (1 << (i10 & 7)))));
            int i12 = i10 + 1;
            this.f8693d = i12;
            if (i12 == this.f8692c) {
                a(bArr2, 0);
            ...
            for (int i17 = 0; i17 < i14; i17++) {
                long[] jArr = this.f8690a;
                jArr[i17] = jArr[i17] ^ b.g1(this.f8691b, i16);
                i16 += 8;
            }
            if (i15 > 0) {
                long[] jArr2 = this.f8690a;
                jArr2[i14] = jArr2[i14] ^ (b.g1(this.f8691b, i16) & ((1 << i15) - 1));
            }
            long[] jArr3 = this.f8690a;
            int i18 = (this.f8692c - 1) >> 6;
        ...
        if (j10 % 8 == 0) {
            while (j11 < j10) {
                ...
                int min = (int) Math.min((long) this.f8693d, j10 - j11);
                byte[] bArr3 = bArr;
                System.arraycopy(this.f8691b, (this.f8692c - this.f8693d) / 8, bArr, ((int) (j11 / 8)) + i, min / 8);
                this.f8693d -= min;
                j11 += (long) min;
            }
            return;
