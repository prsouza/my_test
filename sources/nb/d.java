...
public final class d extends Fragment {
    ...
    public WalletBackupViewModel f8943a;

    /* renamed from: b  reason: collision with root package name */
    public Map<Integer, View> f8944b = new LinkedHashMap();
    ...
    public final android.view.View onCreateView(android.view.LayoutInflater r3, android.view.ViewGroup r4, android.os.Bundle r5) {
        ...
        L_0x0034:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: nb.d.onCreateView(android.view.LayoutInflater, android.view.ViewGroup, android.os.Bundle):android.view.View");
    }
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        WalletBackupViewModel walletBackupViewModel = this.f8943a;
        if (walletBackupViewModel != null) {
            walletBackupViewModel.j();
        }
    }
}
