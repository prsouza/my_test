...
public class r extends ImageView {
    ...
    public final f f1384a;

    /* renamed from: b  reason: collision with root package name */
    public final q f1385b;
    ...
    public final boolean hasOverlappingRendering() {
        if (!(!(this.f1385b.f1366a.getBackground() instanceof RippleDrawable)) || !super.hasOverlappingRendering()) {
            return false;
        }
        return true;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        q qVar = this.f1385b;
        if (!(qVar == null || drawable == null || this.f1386c)) {
