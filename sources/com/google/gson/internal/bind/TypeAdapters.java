...
public final class TypeAdapters {
    ...
    static {
        TypeAdapter<Class> nullSafe = new TypeAdapter<Class>() {
            ...
            public void write(JsonWriter jsonWriter, Class cls) throws IOException {
                StringBuilder d10 = a.d("Attempted to serialize java.lang.Class: ");
        ...
        AnonymousClass14 r06 = new TypeAdapter<Character>() {
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                throw new JsonSyntaxException(a8.a.c("Expecting character, got: ", nextString));
            }
        ...
        AnonymousClass27 r016 = new TypeAdapter<JsonElement>() {
            ...
            public void write(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
                if (jsonElement == null || jsonElement.isJsonNull()) {
                    ...
                    StringBuilder d10 = a.d("Couldn't write ");
                    d10.append(jsonElement.getClass());
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                StringBuilder d10 = a.d("Factory[type=");
                d.h(cls, d10, Marker.ANY_NON_NULL_MARKER);
                d.h(cls2, d10, ",adapter=");
                d10.append(typeAdapter);
                d10.append("]");
                return d10.toString();
            }
        };
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() {
            public <T2> TypeAdapter<T2> create(Gson gson, TypeToken<T2> typeToken) {
                ...
                return new TypeAdapter<T1>() {
                    public T1 read(JsonReader jsonReader) throws IOException {
                        ...
                        StringBuilder d10 = a.d("Expected a ");
            ...
            public String toString() {
                StringBuilder d10 = a.d("Factory[typeHierarchy=");
                d.h(cls, d10, ",adapter=");
                d10.append(typeAdapter);
                d10.append("]");
                return d10.toString();
    ...
    public static <TT> TypeAdapterFactory newFactory(final Class<TT> cls, final Class<TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() {
            ...
            public String toString() {
                StringBuilder d10 = a.d("Factory[type=");
                d.h(cls2, d10, Marker.ANY_NON_NULL_MARKER);
                d.h(cls, d10, ",adapter=");
                d10.append(typeAdapter);
                d10.append("]");
                return d10.toString();
