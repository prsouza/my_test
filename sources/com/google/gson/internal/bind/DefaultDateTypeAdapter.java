...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        ...
        public final TypeAdapterFactory createAdapterFactory(int i, int i10) {
            return createFactory(new DefaultDateTypeAdapter(this, i, i10));
        }
    }
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder d10 = a.d("DefaultDateTypeAdapter(");
            d10.append(((SimpleDateFormat) dateFormat).toPattern());
            d10.append(')');
            return d10.toString();
        }
        StringBuilder d11 = a.d("DefaultDateTypeAdapter(");
    ...
    private DefaultDateTypeAdapter(DateType<T> dateType2, int i, int i10) {
        ArrayList arrayList = new ArrayList();
        this.dateFormats = arrayList;
        this.dateType = (DateType) C$Gson$Preconditions.checkNotNull(dateType2);
        Locale locale = Locale.US;
        ...
        if (JavaVersion.isJava9OrLater()) {
            arrayList.add(PreJava9DateFormatProvider.getUSDateTimeFormat(i, i10));
        }
    }
}
