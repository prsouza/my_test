...
public abstract class UnsafeAllocator {
    public static void assertInstantiable(Class<?> cls) {
        ...
        if (Modifier.isInterface(modifiers)) {
            throw new UnsupportedOperationException(d.a(cls, a.d("Interface can't be instantiated! Interface name: ")));
        } else if (Modifier.isAbstract(modifiers)) {
            throw new UnsupportedOperationException(d.a(cls, a.d("Abstract class can't be instantiated! Class name: ")));
        }
    }
