    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder d10 = a.d("? super ");
                d10.append(C$Gson$Types.typeToString(this.lowerBound));
                return d10.toString();
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                StringBuilder d11 = a.d("? extends ");
                d11.append(C$Gson$Types.typeToString(this.upperBound));
                return d11.toString();
            }
        }
    }
