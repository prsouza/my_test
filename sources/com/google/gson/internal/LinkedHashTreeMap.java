...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public static final class AvlBuilder<K, V> {
        ...
        public void add(Node<K, V> node) {
            ...
            int i11 = this.size + 1;
            this.size = i11;
            int i12 = this.leavesToSkip;
            if (i12 > 0 && (i11 & 1) == 0) {
                this.size = i11 + 1;
                this.leavesToSkip = i12 - 1;
                this.leavesSkipped++;
            }
            int i13 = 4;
            while (true) {
                int i14 = i13 - 1;
                if ((this.size & i14) == i14) {
                    int i15 = this.leavesSkipped;
                    if (i15 == 0) {
    ...
    private void rebalance(Node<K, V> node, boolean z) {
        while (node != null) {
            ...
            if (i12 == -2) {
                ...
                int i13 = node5 != null ? node5.height : 0;
                if (node4 != null) {
                    i = node4.height;
                }
                int i14 = i - i13;
                ...
                int i15 = node7 != null ? node7.height : 0;
                if (node6 != null) {
                    i = node6.height;
                }
                int i16 = i - i15;
    ...
    public Node<K, V> find(K k10, boolean z) {
        int i;
        Node<K, V> node;
        ...
        if (node2 != null) {
            Comparable comparable = comparator2 == NATURAL_ORDER ? (Comparable) k10 : null;
            while (true) {
                if (comparable != null) {
                    i = comparable.compareTo(node2.key);
                } else {
                    i = comparator2.compare(k10, node2.key);
                }
                if (i == 0) {
                    return node2;
                }
    ...
    public static <K, V> Node<K, V>[] doubleCapacity(Node<K, V>[] nodeArr) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (node != null) {
                ...
                Node<K, V> node2 = null;
                nodeArr2[i] = i10 > 0 ? avlBuilder.root() : null;
                int i12 = i + length;
                if (i11 > 0) {
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(Node<K, V> node, K k10, int i, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k10;
            this.hash = i;
            this.height = 1;
