...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i, int i10, char c10) throws IOException {
        int peek = peek();
        if (peek != i10 && peek != i) {
            throw new IllegalStateException("Nesting problem.");
            ...
            StringBuilder d10 = a.d("Dangling name: ");
            d10.append(this.deferredName);
    ...
    private JsonWriter open(int i, char c10) throws IOException {
        beforeValue();
        push(i);
        this.out.write(c10);
        return this;
