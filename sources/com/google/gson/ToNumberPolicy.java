...
public enum ToNumberPolicy implements ToNumberStrategy {
    ...
    LONG_OR_DOUBLE {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x0048, code lost:
            r0 = androidx.activity.result.d.d("Cannot parse ", r1, "; at path ");
            r0.append(r7.getPath());
         */
        ...
        public java.lang.Number readNumber(com.google.gson.stream.JsonReader r7) throws java.io.IOException, com.google.gson.JsonParseException {
            ...
            L_0x0047:
                ...
                java.lang.StringBuilder r0 = androidx.activity.result.d.d(r4, r1, r0)
    ...
    BIG_DECIMAL {
        public BigDecimal readNumber(JsonReader jsonReader) throws IOException {
            ...
            try {
                ...
                StringBuilder d10 = d.d("Cannot parse ", nextString, "; at path ");
                d10.append(jsonReader.getPath());
                throw new JsonParseException(d10.toString(), e10);
            }
        }
    }
}
