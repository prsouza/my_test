...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    public GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i10, @SafeParcelable.Param(id = 3) Bundle bundle) {
        this.zaa = i;
        this.zab = i10;
        this.zac = bundle;
    }
