...
public class DeviceMetaData extends AbstractSafeParcelable {
    ...
    public DeviceMetaData(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) boolean z, @SafeParcelable.Param(id = 3) long j10, @SafeParcelable.Param(id = 4) boolean z10) {
        this.zza = i;
        this.zzb = z;
        this.zzc = j10;
        this.zzd = z10;
