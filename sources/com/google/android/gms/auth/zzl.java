...
public class zzl {
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, int i, String str) throws GoogleAuthException, IOException {
        ...
        if (zzhj.zzd() && zzm(context)) {
            try {
                ...
                zzk(e10, "account change events retrieval");
            }
        }
    ...
    public static Boolean requestGoogleAccountsAccess(Context context) throws GoogleAuthException, IOException {
        ...
        if (zzhj.zze() && zzm(context)) {
            try {
                ...
                zzk(e10, "google accounts access request");
            }
        }
    ...
    private static TokenData zzf(Bundle bundle) throws GoogleAuthException, IOException {
        ...
        if (zzby.zzb(zza2)) {
            Logger logger = zzd;
            String valueOf = String.valueOf(zza2);
            logger.w("GoogleAuthUtil", a.e(new StringBuilder(valueOf.length() + 31), "isUserRecoverableError status: ", valueOf));
            throw new UserRecoverableAuthException(string, intent);
    ...
    /* access modifiers changed from: private */
    public static <T> T zzi(T t10) throws IOException {
        if (t10 != null) {
            return t10;
        }
