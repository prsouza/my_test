...
public interface zzo extends IInterface {
    ...
    void zzo(float f10) throws RemoteException;

    void zzp(boolean z) throws RemoteException;

    void zzq(float f10) throws RemoteException;

    void zzr(float f10, float f11) throws RemoteException;
    ...
    void zzw(float f10) throws RemoteException;

    void zzx(boolean z) throws RemoteException;

    void zzy(float f10) throws RemoteException;
