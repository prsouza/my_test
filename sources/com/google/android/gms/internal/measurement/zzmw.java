...
final class zzmw {
    public static /* bridge */ /* synthetic */ void zza(byte b10, byte b11, byte b12, byte b13, char[] cArr, int i) {
        if (!zze(b11)) {
    ...
    public static /* bridge */ /* synthetic */ void zzb(byte b10, byte b11, byte b12, char[] cArr, int i) {
        if (!zze(b11)) {
            if (b10 == -32) {
                if (b11 >= -96) {
                    b10 = -32;
    ...
    public static /* bridge */ /* synthetic */ void zzc(byte b10, byte b11, char[] cArr, int i) {
        if (b10 < -62 || zze(b11)) {
            throw zzkm.zzc();
        }
