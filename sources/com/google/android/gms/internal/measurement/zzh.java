...
public final class zzh {
    public static double zza(double d10) {
        ...
        if (Double.isInfinite(d10) || d10 == Utils.DOUBLE_EPSILON || i == 0) {
            return d10;
        }
        return Math.floor(Math.abs(d10)) * ((double) (i > 0 ? 1 : -1));
    }
    ...
    public static int zzb(double d10) {
        ...
        return (int) ((long) ((Math.floor(Math.abs(d10)) * ((double) (i > 0 ? 1 : -1))) % 4.294967296E9d));
    }
    ...
    public static boolean zzk(zzap zzap) {
        ...
        Double zzh = zzap.zzh();
        if (zzh.isNaN() || zzh.doubleValue() < Utils.DOUBLE_EPSILON || !zzh.equals(Double.valueOf(Math.floor(zzh.doubleValue())))) {
            return false;
        }
        return true;
    }
