...
interface zznd {
    void zzA(int i, int i10) throws IOException;

    void zzB(int i, List list, boolean z) throws IOException;

    void zzC(int i, long j10) throws IOException;
    ...
    void zzH(int i, int i10) throws IOException;

    void zzI(int i, List list, boolean z) throws IOException;

    void zzJ(int i, long j10) throws IOException;
    ...
    void zzi(int i, int i10) throws IOException;

    void zzj(int i, List list, boolean z) throws IOException;

    void zzk(int i, int i10) throws IOException;

    void zzl(int i, List list, boolean z) throws IOException;

    void zzm(int i, long j10) throws IOException;

    void zzn(int i, List list, boolean z) throws IOException;

    void zzo(int i, float f10) throws IOException;
