...
public final class zzee {
    ...
    /* access modifiers changed from: private */
    public final void zzS(Exception exc, boolean z, boolean z10) {
        this.zzh |= z;
        if (z) {
    ...
    private final void zzT(String str, String str2, Bundle bundle, boolean z, boolean z10, Long l10) {
        zzU(new zzdr(this, l10, str, str2, bundle, z, z10));
    }
