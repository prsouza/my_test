...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzg, List list) {
        ...
        int i = 0;
        if (ordinal == 3) {
            zzap zzb = zzg.zzb((zzap) m.a(zzbl.ASSIGN, 2, list, 0));
            ...
            if (list.size() % 2 == 0) {
                ...
                while (i10 < list.size() - 1) {
                    zzap zzb3 = zzg.zzb((zzap) list.get(i10));
                    if (zzb3 instanceof zzat) {
                        zzg.zzf(zzb3.zzi(), zzg.zzb((zzap) list.get(i10 + 1)));
                        i10 += 2;
                    } else {
            ...
            zzap zzb4 = zzg.zzb((zzap) m.a(zzbl.GET, 1, list, 0));
            ...
            zzap zzb5 = zzg.zzb((zzap) m.a(zzbl.SET_PROPERTY, 3, list, 0));
            ...
            if (ordinal != 18) {
                if (ordinal == 35 || ordinal == 36) {
                    zzap zzb8 = zzg.zzb((zzap) m.a(zzbl.GET_PROPERTY, 2, list, 0));
                ...
                switch (ordinal) {
                    case 62:
                        zzap zzb10 = zzg.zzb((zzap) m.a(zzbl.TYPEOF, 1, list, 0));
