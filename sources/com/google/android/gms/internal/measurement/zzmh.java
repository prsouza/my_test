...
class zzmh extends AbstractMap {
    ...
    public /* synthetic */ zzmh(int i, zzmg zzmg) {
        this.zza = i;
    }
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i <= size) {
            int i10 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzmb) this.zzb.get(i10)).zza());
            if (compareTo2 < 0) {
                size = i10 - 1;
    ...
    public final int hashCode() {
        ...
        for (int i10 = 0; i10 < zzb2; i10++) {
            i += ((zzmb) this.zzb.get(i10)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i10 = this.zza;
        if (size == i10) {
            zzmb zzmb = (zzmb) this.zzb.remove(i10 - 1);
