...
public final class zzhm implements zzhk {
    ...
    static {
        ...
        zza = zza2.zzb("getTokenRefactor__account_data_service_sample_percentage", Utils.DOUBLE_EPSILON);
        ...
        try {
            ...
            zzn = zza2.zzb("getTokenRefactor__gms_account_authenticator_sample_percentage", Utils.DOUBLE_EPSILON);
        } catch (zzew e10) {
            throw new AssertionError("Could not parse proto flag \"getTokenRefactor__blocked_packages\"", e10);
        }
    }
