...
final class zzjs implements Runnable {
    ...
    public zzjs(zzkb zzkb, AtomicReference atomicReference, String str, String str2, String str3, zzp zzp) {
        this.zze = zzkb;
    ...
    public final void run() {
        ...
        synchronized (this.zza) {
            try {
                ...
                try {
                    this.zze.zzs.zzaz().zzd().zzd("(legacy) Failed to get conditional properties; remote exception", (Object) null, this.zzb, e10);
                    this.zza.set(Collections.emptyList());
                    atomicReference = this.zza;
                } catch (Throwable th2) {
                    this.zza.notify();
