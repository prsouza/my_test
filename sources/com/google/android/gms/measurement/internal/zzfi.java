            ...
            for (String next : bundle.keySet()) {
                ...
                if (obj != null) {
                    try {
                        ...
                        jSONObject.put(GoogleApiAvailabilityLight.TRACKING_SOURCE_NOTIFICATION, next);
                        ...
                        this.zza.zzs.zzaz().zzd().zzb("Cannot serialize bundle value to SharedPreferences", e10);
                    }
                }
            }
