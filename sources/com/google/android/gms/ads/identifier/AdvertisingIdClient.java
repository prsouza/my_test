...
public class AdvertisingIdClient {
    ...
    public static Info getAdvertisingIdInfo(Context context) throws IOException, IllegalStateException, GooglePlayServicesNotAvailableException, GooglePlayServicesRepairableException {
        ...
        try {
            ...
            advertisingIdClient.zzc(zzd2, true, 0.0f, SystemClock.elapsedRealtime() - elapsedRealtime, BuildConfig.FLAVOR, (Throwable) null);
    ...
    @VisibleForTesting
    public final boolean zzc(Info info, boolean z, float f10, long j10, String str, Throwable th2) {
