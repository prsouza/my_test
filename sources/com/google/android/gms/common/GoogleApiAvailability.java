...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                mVar.f3102t.icon = context.getApplicationInfo().icon;
                mVar.f3092j = 2;
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    mVar.f3086b.add(new j(R.drawable.common_full_open_on_phone, resources.getString(R.string.common_open_on_phone), pendingIntent));
                } else {
                    mVar.g = pendingIntent;
                }
            } else {
                mVar.f3102t.icon = 17301642;
                String string = resources.getString(R.string.common_google_play_services_notification_ticker);
                mVar.f3102t.tickerText = m.c(string);
                mVar.f3102t.when = System.currentTimeMillis();
                mVar.g = pendingIntent;
                mVar.e(zae);
            }
            if (PlatformVersion.isAtLeastO()) {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i10, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(activity, i, zag.zab(activity, getErrorResolutionIntent(activity, i, GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG), i10), onCancelListener);
    }
    ...
    public Dialog getErrorDialog(Fragment fragment, int i, int i10) {
        return getErrorDialog(fragment, i, i10, (DialogInterface.OnCancelListener) null);
    }

    public Dialog getErrorDialog(Fragment fragment, int i, int i10, DialogInterface.OnCancelListener onCancelListener) {
        return zaa(fragment.requireContext(), i, zag.zac(fragment, getErrorResolutionIntent(fragment.requireContext(), i, GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG), i10), onCancelListener);
    }
}
