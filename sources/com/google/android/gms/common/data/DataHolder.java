...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public DataHolder(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) String[] strArr, @SafeParcelable.Param(id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(id = 3) int i10, @SafeParcelable.Param(id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
    ...
    private static CursorWindow[] zaf(Builder builder, int i) {
        ...
        while (i10 < size) {
            try {
                ...
                Map map = (Map) zab2.get(i10);
                int i11 = 0;
                boolean z10 = true;
                while (true) {
                    if (i11 < builder.zaa.length) {
                        if (!z10) {
                            break;
                        }
                        ...
                        if (obj == null) {
                            ...
                            z10 = cursorWindow.putLong((long) ((Integer) obj).intValue(), i10, i11);
                        } else if (obj instanceof Boolean) {
                            z10 = cursorWindow.putLong(true != ((Boolean) obj).booleanValue() ? 0 : 1, i10, i11);
                        } else if (obj instanceof byte[]) {
                            z10 = cursorWindow.putBlob((byte[]) obj, i10, i11);
                        } else if (obj instanceof Double) {
                            z10 = cursorWindow.putDouble(((Double) obj).doubleValue(), i10, i11);
                        } else if (obj instanceof Float) {
                            z10 = cursorWindow.putDouble((double) ((Float) obj).floatValue(), i10, i11);
                        } else {
    ...
    @KeepForSdk
    public boolean getBoolean(String str, int i, int i10) {
        zae(str, i);
        return Long.valueOf(this.zah[i10].getLong(i, this.zab.getInt(str))).longValue() == 1;
    }

    @KeepForSdk
    public byte[] getByteArray(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].getBlob(i, this.zab.getInt(str));
    }
    ...
    @KeepForSdk
    public int getInteger(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].getInt(i, this.zab.getInt(str));
    }

    @KeepForSdk
    public long getLong(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].getLong(i, this.zab.getInt(str));
    }
    ...
    @KeepForSdk
    public String getString(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].getString(i, this.zab.getInt(str));
    }
    ...
    @KeepForSdk
    public boolean hasNull(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].isNull(i, this.zab.getInt(str));
    }
    ...
    public final double zaa(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].getDouble(i, this.zab.getInt(str));
    }

    public final float zab(String str, int i, int i10) {
        zae(str, i);
        return this.zah[i10].getFloat(i, this.zab.getInt(str));
    }

    public final void zac(String str, int i, int i10, CharArrayBuffer charArrayBuffer) {
        zae(str, i);
        this.zah[i10].copyStringToBuffer(i, this.zab.getInt(str), charArrayBuffer);
    }
    ...
    public final void zad() {
        ...
        while (true) {
            ...
            if (i < cursorWindowArr.length) {
                this.zac[i] = i11;
                i11 += this.zah[i].getNumRows() - (i11 - cursorWindowArr[i].getStartPosition());
                i++;
            } else {
                this.zad = i11;
                return;
