...
public final class zax extends AbstractSafeParcelable {
    ...
    public zax(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i10, @SafeParcelable.Param(id = 3) int i11, @SafeParcelable.Param(id = 4) Scope[] scopeArr) {
        this.zaa = i;
        this.zab = i10;
        this.zac = i11;
        this.zad = scopeArr;
