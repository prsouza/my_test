    ...
    public final void zza(zzn zzn, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.zzb) {
            ...
            if (zzo == null) {
                ...
                StringBuilder sb2 = new StringBuilder(zzn2.length() + 50);
                ...
                StringBuilder sb3 = new StringBuilder(zzn3.length() + 76);
        ...
        synchronized (this.zzb) {
            ...
            if (zzo == null) {
                ...
                if (!zzo.zzh(serviceConnection)) {
                    ...
                    String zzn2 = zzn.toString();
                    StringBuilder sb2 = new StringBuilder(zzn2.length() + 81);
