...
public final class zzn extends AbstractSafeParcelable {
    ...
    public zzn(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) boolean z, @SafeParcelable.Param(id = 3) boolean z10, @SafeParcelable.Param(id = 4) IBinder iBinder, @SafeParcelable.Param(id = 5) boolean z11) {
        this.zza = str;
        this.zzb = z;
        this.zzc = z10;
