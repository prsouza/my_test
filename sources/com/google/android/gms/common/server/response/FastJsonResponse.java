...
public abstract class FastJsonResponse {
    ...
    private final <I, O> void zaE(Field<I, O> field, I i) {
        ...
        switch (i10) {
            ...
            default:
                throw new IllegalStateException(a.b(44, "Unsupported type for conversion: ", i10));
        }
    }
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public Field(int i, boolean z, int i10, boolean z10, String str, int i11, Class<? extends FastJsonResponse> cls, FieldConverter<I, O> fieldConverter) {
            this.zai = 1;
            this.zaa = i;
            this.zab = z;
            this.zac = i10;
