...
public final class ApiKey<O extends Api.ApiOptions> {
    ...
    private ApiKey(Api<O> api, O o4, String str) {
        this.zab = api;
        this.zac = o4;
        this.zad = str;
        this.zaa = Objects.hashCode(api, o4, str);
    }

    public static <O extends Api.ApiOptions> ApiKey<O> zaa(Api<O> api, O o4, String str) {
