...
public final class zabq<O extends Api.ApiOptions> implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final boolean zaL(zai zai2) {
        ...
        e.b(sb2, name, " could not execute call because it requires feature (", name2, ", ");
        sb2.append(version);
        sb2.append(").");
    ...
    public static /* bridge */ /* synthetic */ void zam(zabq zabq, zabs zabs) {
        ...
        if (zabq.zak.remove(zabs)) {
            ...
            for (zai next : zabq.zab) {
                if ((next instanceof zac) && (zab2 = ((zac) next).zab(zabq)) != null && ArrayUtils.contains((T[]) zab2, zaa2)) {
                    arrayList.add(next);
                }
            }
            int size = arrayList.size();
            for (int i = 0; i < size; i++) {
                ...
                zai2.zae(new UnsupportedApiCallException(zaa2));
            }
        }
    }
