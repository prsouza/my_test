...
public final class GoogleServices {
    ...
    public Status checkGoogleAppId(String str) {
        ...
        return new Status(10, d.b(new StringBuilder(String.valueOf(str3).length() + 97), "Initialize was called with two different Google App IDs.  Only the first app ID will be used: '", str3, "'."));
    }
