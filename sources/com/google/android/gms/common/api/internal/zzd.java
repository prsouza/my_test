...
public final class zzd extends Fragment implements LifecycleFragment {
    private static final WeakHashMap<r, WeakReference<zzd>> zza = new WeakHashMap<>();
    ...
    public static zzd zzc(r rVar) {
        zzd zzd2;
        WeakHashMap<r, WeakReference<zzd>> weakHashMap = zza;
        WeakReference weakReference = weakHashMap.get(rVar);
        if (weakReference != null && (zzd2 = (zzd) weakReference.get()) != null) {
            return zzd2;
        }
        try {
            zzd zzd3 = (zzd) rVar.getSupportFragmentManager().F("SupportLifecycleFragmentImpl");
            if (zzd3 == null || zzd3.isRemoving()) {
                zzd3 = new zzd();
                androidx.fragment.app.a aVar = new androidx.fragment.app.a(rVar.getSupportFragmentManager());
                aVar.e(0, zzd3, "SupportLifecycleFragmentImpl", 1);
                aVar.h();
            }
            weakHashMap.put(rVar, new WeakReference(zzd3));
            return zzd3;
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(d.b(new StringBuilder(String.valueOf(str).length() + 59), "LifecycleCallback with tag ", str, " already added to this fragment."));
    }
    ...
    public final void onActivityResult(int i, int i10, Intent intent) {
        ...
        for (LifecycleCallback onActivityResult : this.zzb.values()) {
            onActivityResult.onActivityResult(i, i10, intent);
        }
    }
