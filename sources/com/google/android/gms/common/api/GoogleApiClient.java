...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(r rVar);
    ...
    public static final class Builder {
        ...
        private final <O extends Api.ApiOptions> void zab(Api<O> api, O o4, Scope... scopeArr) {
            HashSet hashSet = new HashSet(((Api.BaseClientBuilder) Preconditions.checkNotNull(api.zac(), "Base client builder must not be null")).getImpliedScopes(o4));
        ...
        public GoogleApiClient build() {
            ...
            for (Api next : this.zaj.keySet()) {
                ...
                boolean z10 = zad2.get(next) != null;
                aVar.put(next, Boolean.valueOf(z10));
                zat zat = new zat(next, z10);
                arrayList.add(zat);
                ...
                if (buildClient.providesSignIn()) {
                    if (api == null) {
                        ...
                        String zad4 = api.zad();
                        throw new IllegalStateException(d.b(new StringBuilder(String.valueOf(zad3).length() + 21 + String.valueOf(zad4).length()), zad3, " cannot be used with ", zad4));
                    }
                }
            }
            if (api != null) {
                if (!z) {
                    ...
                    String zad5 = api.zad();
                    throw new IllegalStateException(d.b(new StringBuilder(String.valueOf(zad5).length() + 82), "With using ", zad5, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
        ...
        public Builder enableAutoManage(r rVar, int i, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        public Builder enableAutoManage(r rVar, OnConnectionFailedListener onConnectionFailedListener) {
