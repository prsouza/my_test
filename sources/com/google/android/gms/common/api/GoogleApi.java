...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    public GoogleApi(Activity activity, Api<O> api, O o4, Settings settings) {
        this((Context) activity, activity, api, o4, settings);
    }

    private final <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T zad(int i, T t10) {
        t10.zak();
        this.zaa.zaw(this, i, t10);
        return t10;
    }
    ...
    private GoogleApi(Context context, Activity activity, Api<O> api, O o4, Settings settings) {
        ...
        ApiKey<O> zaa2 = ApiKey.zaa(api, o4, str);
        this.zaf = zaa2;
