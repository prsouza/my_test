...
final class zzm {
    ...
    public static zzw zza(String str, zzi zzi, boolean z, boolean z10) {
        StrictMode.ThreadPolicy allowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            return zzf(str, zzi, z, z10);
        } finally {
    ...
    public static zzw zzb(String str, boolean z, boolean z10, boolean z11) {
        zzw zzw;
        String str2;
        StrictMode.ThreadPolicy allowThreadDiskReads = StrictMode.allowThreadDiskReads();
        try {
            ...
            try {
                ...
                zzw = zzw.zzd(str2, e10);
            }
        } catch (RemoteException e11) {
            Log.e("GoogleCertificates", "Failed to get Google certificates from remote", e11);
            zzw = zzw.zzd("module call", e11);
        } catch (Throwable th2) {
            StrictMode.setThreadPolicy(allowThreadDiskReads);
            throw th2;
        }
    ...
    private static zzw zzf(String str, zzi zzi, boolean z, boolean z10) {
        String str2;
        try {
            zzg();
            Preconditions.checkNotNull(zzg);
            try {
                return zze.zzf(new zzs(str, zzi, z, z10), ObjectWrapper.wrap(zzg.getPackageManager())) ? zzw.zzb() : new zzv(new zzd(z, str, zzi), (zzu) null);
