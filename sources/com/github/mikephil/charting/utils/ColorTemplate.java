...
public class ColorTemplate {
    public static final int[] COLORFUL_COLORS = {Color.rgb(193, 37, 82), Color.rgb(255, LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY, 0), Color.rgb(245, 199, 0), Color.rgb(106, 150, 31), Color.rgb(179, 100, 53)};
    ...
    public static int colorWithAlpha(int i, int i10) {
        return (i & 16777215) | ((i10 & 255) << 24);
    }
