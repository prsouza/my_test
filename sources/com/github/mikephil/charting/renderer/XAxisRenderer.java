    ...
    public void drawLabels(Canvas canvas, float f10, MPPointF mPPointF) {
        ...
        for (int i11 = 0; i11 < i; i11 += 2) {
            ...
            if (this.mViewPortHandler.isInBoundsX(f12)) {
                ...
                int i12 = i11 / 2;
                String axisLabel = valueFormatter.getAxisLabel(xAxis.mEntries[i12], xAxis);
                if (this.mXAxis.isAvoidFirstLastClippingEnabled()) {
                    ...
                    if (i12 == i13 - 1 && i13 > 1) {
                        ...
                        f11 = (((float) Utils.calcTextWidth(this.mAxisLabelPaint, axisLabel)) / 2.0f) + f12;
    ...
    public void renderAxisLabels(Canvas canvas) {
        if (this.mXAxis.isEnabled() && this.mXAxis.isDrawLabelsEnabled()) {
            ...
            if (this.mXAxis.getPosition() == XAxis.XAxisPosition.TOP) {
                instance.f3610x = 0.5f;
                instance.f3611y = 1.0f;
    ...
    public void renderLimitLineLabel(Canvas canvas, LimitLine limitLine, float[] fArr, float f10) {
        ...
        if (label != null && !label.equals(BuildConfig.FLAVOR)) {
            ...
            if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                ...
                canvas.drawText(label, fArr[0] + xOffset, this.mViewPortHandler.contentTop() + f10 + ((float) Utils.calcTextHeight(this.mLimitLinePaint, label)), this.mLimitLinePaint);
            } else if (labelPosition == LimitLine.LimitLabelPosition.RIGHT_BOTTOM) {
                this.mLimitLinePaint.setTextAlign(Paint.Align.LEFT);
                canvas.drawText(label, fArr[0] + xOffset, this.mViewPortHandler.contentBottom() - f10, this.mLimitLinePaint);
